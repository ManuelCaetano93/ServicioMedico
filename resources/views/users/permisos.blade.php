            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/usuarios/'.$user->id. '/asignarpermisos') }}">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $user->name or old('name') }}"  autofocus readonly>
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    @foreach($permisos as $permiso)
                                        <label class="checkbox-inline">
                                            <input class="i-check" type="checkbox" id="permisos" name="permisos[]" value="{{ $permiso->name }}"
